			...
			while(subMenuT != 0) 
				...
				switch (subMenuT){
					case 1: 
						...
						if(Pp = !ObterPacientePeloCodigo(codigo)){
					...
					case 2: 
						...
						if(Bb = !ObterBruxoPeloCodigo(codigo)){
							printf("Codigo invalido!");
							free(Bb);
						}
					...
					case 3:
						...
						if(Bb = !ObterBruxoPeloCodigo(t.codigoBruxo)){
						...
						if(Pp = !ObterPacientePeloCodigo(t.codigoPaciente)){
							printf("\nERRO: Codigo Invalido!\n");
						...
						if(Pcp = !ObterPocaoPeloCodigo(t.codigoPocao)){
							printf("\nERRO: Codigo Invalido!\n");
